...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form id="form1" runat="server" action="recover-password.html" method="post">
        <div class="input-group mb-3">
          <asp:TextBox id="email" runat="server" class="form-control" placeholder="Email"/>
        ...
        <div class="row">
          <div class="col-12">
            <asp:Button Id="req_password" runat="server" class="btn btn-primary btn-block" Text="Request new password" />
          </div>
          <!-- /.col -->
        </div>
      </form>
